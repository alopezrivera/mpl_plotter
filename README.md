...
![](tests/coverage/coverage.svg ".coverage available in tests/coverage/") ![Monthly downloads](https://pepy.tech/badge/mpl-plotter/month)](https://pepy.tech/project/mpl-plotter)
